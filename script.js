...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (pdfContainer) {
        const renderResume = async () => {
            ...
            const pdf = await pdfjsLib.getDocument('resume.pdf?v=20260403').promise;
        ...
        try {
            ...
            pdfContainer.innerHTML = '<p class="resume-fallback">Unable to load resume. <a href="resume.pdf?v=20260403" target="_blank">Download resume</a></p>';
        }
    }
